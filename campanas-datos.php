...
<?php }elseif ($campania_dato=="material"){
    ...
    /*DOCUMENTOS*/
    $rst_cas_docs=mysql_query("SELECT * FROM DM_campania_material WHERE campania=$campania_id ORDER BY orden ASC;", $conexion);
...
<?php }elseif ($campania_dato=="nota-prensa"){ ?>
    ...
    <article class="categoria_noticias">
        ...
        <div class="datos">
            <h3><a target="_blank" href="campanias/nota/<?php echo $noticias_id."/".$noticias_url; ?>"><?php echo $noticias_titulo; ?></a></h3>
            <div class="imagen">
