...
if(vars.currentImage.attr('title')!=''){var title=vars.currentImage.attr('title');if(title.substr(0,1)=='#')title=$(title).html();if($('.nivo-caption',slider).css('display')=='block'){$('.nivo-caption',slider).animate({left:'-500'},400).fadeOut(settings.animSpeed,function(){$(this).html(title);$(this).animate({left:'50'},400,function(){$(this).animate({left:'0'},400)}).fadeIn(settings.animSpeed);});}else{$('.nivo-caption',slider).html(title);}
