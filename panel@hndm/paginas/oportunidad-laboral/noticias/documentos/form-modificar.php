...
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_oportunidad_laboral_documentos WHERE id=". $_REQUEST["id"].";", $conexion);
...
jq(function() {
    ...
    filters: [ {title: "Documentos | Imagenes", extensions: "doc,docx,xls,xlsx,ppt,pptx,pps,ppsx,pdf,jpg,jpeg,gif,png,zip,rar"}],
