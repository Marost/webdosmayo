...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_tarifario WHERE id>0 AND tipo=2 ORDER BY id ASC;", $conexion);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_tarifario WHERE id>0 AND tipo=2 ORDER BY id ASC LIMIT $inicio, $registros;", $conexion);
...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_tarifario WHERE titulo LIKE '%$buscar%' AND tipo=2 ORDER BY id ASC;", $conexion);
	$num_registros=mysql_num_rows($rst_query);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_tarifario WHERE titulo LIKE '%$buscar%' AND tipo=2 ORDER BY id ASC LIMIT $inicio, $registros;", $conexion);
	$paginas=ceil($num_registros/$registros);
