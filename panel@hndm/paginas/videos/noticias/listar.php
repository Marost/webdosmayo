...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_videos ORDER BY fecha_publicacion DESC;", $conexion);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_videos ORDER BY fecha_publicacion DESC LIMIT $inicio, $registros;", $conexion);
