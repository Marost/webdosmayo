...
//NOTICIA
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_info_variada WHERE id=". $_REQUEST["id"].";", $conexion);
...
<div id="contenedor" class="limpiar">
    ...
    <div id="cuerpo" class="limpiar">
    	<div class="interior">
            ...
            <div id="panel-der">
            	<h2>Modificar - Información Variada</h2>
            ...
            <tr>
                ...
                <form action="actualizar.php?id=<?php echo $_REQUEST["id"]; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
            	  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
            	    ...
            	    <tr>
            	      <td height="30" align="right"><p><strong>Observaciones:</strong></p></td>
            	      <td height="30" align="left">&nbsp;</td>
          	      </tr>
            	    <tr>
            	      <td height="35" colspan="2" align="center"><p>
            	        <label>
            	          <textarea class="ckeditor" name="contenido" id="contenido"><?php echo $fila_query["observaciones"] ?></textarea>
          	          </label>
          	        </p></td>
          	      </tr>
                  <tr>
