...
$rst_nota=mysql_query("SELECT * FROM ".$tabla_suf."_info_variada WHERE id=$idnoticia", $conexion);
...
//SELECCIONAR ARCHIVO
$rst_archivo=mysql_query("SELECT * FROM ".$tabla_suf."_info_variada_documentos WHERE id=$idselect", $conexion);
...
mysql_query("DELETE FROM ".$tabla_suf."_info_variada_documentos WHERE id=$idselect;",$conexion);
