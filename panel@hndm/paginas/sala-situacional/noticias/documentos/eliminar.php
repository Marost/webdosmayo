...
$rst_nota=mysql_query("SELECT * FROM ".$tabla_suf."_sala_situacional WHERE id=$idnoticia", $conexion);
...
//SELECCIONAR ARCHIVO
$rst_archivo=mysql_query("SELECT * FROM ".$tabla_suf."_sala_situacional_documentos WHERE id=$idselect", $conexion);
...
unlink($UrlArchivo);
mysql_query("DELETE FROM ".$tabla_suf."_sala_situacional_documentos WHERE id=$idselect;",$conexion);
