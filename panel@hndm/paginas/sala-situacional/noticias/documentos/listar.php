...
$rst_galeria=mysql_query("SELECT * FROM ".$tabla_suf."_sala_situacional_documentos WHERE cas=$idnoticia ORDER BY orden ASC;", $conexion);
...
//NOTICIA
$rst_noticia=mysql_query("SELECT * FROM ".$tabla_suf."_sala_situacional WHERE id=$idnoticia LIMIT 1;", $conexion);
