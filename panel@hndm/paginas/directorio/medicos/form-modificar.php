...
//NOTICIA
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_directorio WHERE id=". $_REQUEST["id"].";", $conexion);
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <form action="actualizar.php?id=<?php echo $_REQUEST["id"]; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
                  ...
                  <tr>
                    <td width="20%" height="30" align="right" ><p><strong>Cargo:</strong></p></td>
                    <td width="80%" height="30" align="left"><input name="cargo" type="text" id="cargo" size="50" value="<?php echo $fila_query["cargo"] ?>" /></td>
                  </tr>
            	    <tr>
