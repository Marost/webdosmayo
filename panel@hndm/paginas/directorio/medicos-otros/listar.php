...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_medicos;", $conexion);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_medicos LIMIT $inicio, $registros;", $conexion);
...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_medicos WHERE nombre LIKE '%$buscar%';", $conexion);
	$num_registros=mysql_num_rows($rst_query);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_medicos WHERE nombre LIKE '%$buscar%' LIMIT $inicio, $registros;", $conexion);
	$paginas=ceil($num_registros/$registros);
                        ...
                        <tbody>
                          ...
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            <td width="85%">
                                ...
                                <strong><?php echo $fila["nombre"] ?></strong></p>
                              <p><?php echo $fila["oficina"] ?></p>
                            </td>
