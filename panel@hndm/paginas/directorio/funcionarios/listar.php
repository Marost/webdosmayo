...
if ($_REQUEST["btnbuscar"]=="")
{
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_directorio_funcionarios ORDER BY titulo ASC LIMIT $inicio, $registros;", $conexion);
...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_directorio_funcionarios WHERE titulo LIKE '%$buscar%' ORDER BY titulo ASC;", $conexion);
	$num_registros=mysql_num_rows($rst_query);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_directorio_funcionarios WHERE titulo LIKE '%$buscar%' ORDER BY titulo ASC LIMIT $inicio, $registros;", $conexion);
	$paginas=ceil($num_registros/$registros);
...
<div id="contenedor" class="limpiar">
    ...
    <div id="cuerpo" class="limpiar">
    	<div class="interior">
            ...
            <div id="panel-der">
            	<h2>Lista - Otros Funcionarios</h2>
