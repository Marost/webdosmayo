...
$rst_notgaleria=mysql_query("SELECT * FROM ".$tabla_suf."_epidemiologico_documentos WHERE cas=$idnoticia", $conexion);
...
$documentos=seleccionTabla($idnoticia, "id", "DM_epidemiologico", $conexion);
...
if($num_notgaleria>0){
	...
	while($_POST['flash_uploader_'.$cont.'_tmpname']<>""){
		...
		mysql_query("INSERT INTO ".$tabla_suf."_epidemiologico_documentos (titulo, documento, documento_tipo, cas, orden)
