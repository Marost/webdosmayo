...
//NOTICIA
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_transp_s_cont WHERE id=". $_REQUEST["id"].";", $conexion);
            	  ...
            	  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
            	    ...
            	    <tr>
            	      <td height="35" colspan="2" align="center"><p>
            	        <label>
            	          <textarea class="ckeditor" name="contenido" id="contenido"><?php echo $nota_contenido; ?></textarea>
          	          </label>
          	        </p></td>
          	      </tr>
