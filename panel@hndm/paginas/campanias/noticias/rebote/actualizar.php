...
$documentos=seleccionTabla($idnoticia, "id", "DM_campania_rebote", $conexion);
...
mysql_query("UPDATE ".$tabla_suf."_campania_rebote SET titulo='".htmlspecialchars($titulo)."', documento='$archivo_name', 
