...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_campania WHERE id>0 ORDER BY fecha_publicacion DESC;", $conexion);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_campania WHERE id>0 ORDER BY fecha_publicacion DESC LIMIT $inicio, $registros;", $conexion);
...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_campania WHERE titulo LIKE '%$buscar%' ORDER BY fecha_publicacion DESC;", $conexion);
	$num_registros=mysql_num_rows($rst_query);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_campania WHERE titulo LIKE '%$buscar%' ORDER BY fecha_publicacion DESC LIMIT $inicio, $registros;", $conexion);
	$paginas=ceil($num_registros/$registros);
                        ...
                        <tbody>
                          ...
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            ...
                            <td width="15%" align="center">
                                ...
                                <a href="../nota-prensa/listar.php?campania=<?php echo $fila["id"] ?>">
                                    <img src="../../../images/noticia_portada.png" width="16" height="16" title="Noticias" /></a>

                                <a href="material/listar.php?campania=<?php echo $fila["id"] ?>">
                                    <img src="../../../images/pag_16.png" width="16" height="16" title="Material Comunicacional" /></a>

                                <a href="rebote/listar.php?campania=<?php echo $fila["id"] ?>">
                                    <img src="../../../images/mult_32.png" width="16" height="16" title="Rebote en Medios" /></a>
