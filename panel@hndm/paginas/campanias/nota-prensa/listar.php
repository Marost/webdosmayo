...
if ($_REQUEST["btnbuscar"]==""){
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_campania_noticia WHERE campania=$idcampania ORDER BY fecha_publicacion DESC;", $conexion);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_campania_noticia WHERE campania=$idcampania ORDER BY fecha_publicacion DESC LIMIT $inicio, $registros;", $conexion);
...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_campania_noticia WHERE campania=$idcampania AND titulo LIKE '%$buscar%' ORDER BY fecha_publicacion DESC;", $conexion);
	$num_registros=mysql_num_rows($rst_query);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_campania_noticia WHERE campania=$idcampania AND titulo LIKE '%$buscar%' ORDER BY fecha_publicacion DESC LIMIT $inicio, $registros;", $conexion);
	$paginas=ceil($num_registros/$registros);
...
function eliminarRegistro(registro, nombre, campania) {
if(confirm("¿Está seguro de borrar este registro?\n"+nombre)) {
	document.location.href="eliminar.php?id="+registro+"&campania="+campania;
	}
}
</script>
</head>
    ...
    <div id="contenido_total">
        ...
        <div id="contenido">
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td colspan="2"><p><a href="form-agregar.php?campania=<?php echo $idcampania; ?>"><strong>AGREGAR</strong></a></p></td>
                  </tr>
                  <tr>
                    <td colspan="2">
                        ...
                        <tbody>
                          ...
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            ...
                            <td width="15%" align="center">
                                ...
                                <a onclick="eliminarRegistro(<?php echo $fila["id"] ?>, '<?php echo $fila["titulo"] ?>', <?php echo $idcampania; ?>);" href="javascript:;">
                                    <img src="../../../images/eliminar_16.png" width="16" height="16" title="Eliminar registro" /></a>
                            
                           		  <a href="form-modificar.php?id=<?php echo $fila["id"] ?>&campania=<?php echo $idcampania; ?>">
