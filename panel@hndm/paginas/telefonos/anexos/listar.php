...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_dirtelefono ORDER BY id ASC;", $conexion);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_dirtelefono ORDER BY id ASC LIMIT $inicio, $registros;", $conexion);
...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_dirtelefono WHERE titulo LIKE '%$buscar%' ORDER BY id ASC;", $conexion);
	$num_registros=mysql_num_rows($rst_query);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_dirtelefono WHERE titulo LIKE '%$buscar%' ORDER BY id ASC LIMIT $inicio, $registros;", $conexion);
	$paginas=ceil($num_registros/$registros);
                        ...
                        <tbody>
                          ...
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            ...
                            <td width="15%" align="center">
                                ...
                                <a href="noticias/listar.php?anx=<?php echo $fila["id"] ?>">
                                  <img src="../../../images/list_16.png" width="16" height="16" title="Lista de Anexos" /></a>
