                ...
                <form action="guardar.php" method="post" enctype="multipart/form-data" id="form1" >
            	  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
            	    ...
            	    <tr>
            	      ...
            	      <td width="80%" height="30" align="left"><input name="anexo" type="text" id="anexo" size="50" /></td>
          	      </tr>
                  <tr>
                    <td width="20%" height="30" align="right" ><p><strong>Sección:</strong></p></td>
                    <td width="80%" height="30" align="left"><input name="seccion" type="text" id="seccion" size="50" /></td>
                  </tr>
                  <tr>
                    <td width="20%" height="30" align="right" ><p><strong>Doctor:</strong></p></td>
                    <td width="80%" height="30" align="left"><input name="doctor" type="text" id="doctor" size="50" /></td>
                  </tr>
                <tr>
