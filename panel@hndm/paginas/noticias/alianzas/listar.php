...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_noticia WHERE id>0 AND categoria=1 ORDER BY fecha_publicacion DESC;", $conexion);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_noticia WHERE id>0 AND categoria=1 ORDER BY fecha_publicacion DESC LIMIT $inicio, $registros;", $conexion);
...
{
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_noticia WHERE titulo LIKE '%$buscar%' AND categoria=1 ORDER BY fecha_publicacion DESC;", $conexion);
	$num_registros=mysql_num_rows($rst_query);
	...
	$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_noticia WHERE titulo LIKE '%$buscar%' AND categoria=1 ORDER BY fecha_publicacion DESC LIMIT $inicio, $registros;", $conexion);
	$paginas=ceil($num_registros/$registros);
                      ...
                      <table width="100%" align="center" cellpadding="5" cellspacing="0" id="cebreado-php">
                        ...
                        <tbody>
                          ...
                          <tr<?php echo alt($zebra); $zebra++; ?>>
                            ...
                            <?php //if($fila_prv_user["Alianzas_eliminar"]==1){ ?>
                            ...
                            <?php //} ?>
                            <?php// if($fila_prv_user["Alianzas_modificar"]==1){ ?>
