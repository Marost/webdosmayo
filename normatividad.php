...
if($buscar<>""){
    ...
    $pagination     = new Pagination("5", $generated, $page, $url_web."&page", 1, 0);
    $start          = $pagination->prePagination();
    $rst_cas        = mysql_query("SELECT * FROM DM_normatividad WHERE titulo LIKE '%$buscar%' ORDER BY fecha_publicacion DESC LIMIT $start, 5", $conexion);
}
                        ...
                        <div class="nw-nota cas">
                            ...
                            <div class="contenido">
                                ...
                                <div id="busqueda_cabecera">
                                    ...
                                    <form name="busqueda" action="normatividad" class="search-form noframe nobtn rsmall">
