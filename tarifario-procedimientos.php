                        ...
                        <div class="nw-nota">
                            ...
                            <div class="contenido">
                                ...
                                <div id="tarifario_cabecera">
                                  <ul>
                                    <li><a id="tarif_medicamento" href="javascript:;">Medicamentos</a></li>
                                    <li class="selected"><a id="tarif_procedimiento" class="active" href="javascript:;">Procedimientos</a></li>
                                  </ul>
                                </div>
